 ...
 * Thresholds are overridable via env (tuning), never silently widened.
 */
...
const MAX_TARBALL = Number(process.env.VIBEOS_PACK_MAX_TARBALL ?? 3 * 1024 * 1024)
const MAX_UNPACKED = Number(process.env.VIBEOS_PACK_MAX_UNPACKED ?? 10 * 1024 * 1024)
...
const dir = mkdtempSync(join(tmpdir(), 'vibeos-pack-'))
try {
