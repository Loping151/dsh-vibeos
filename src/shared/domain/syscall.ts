/* Derived from VibeOS (https://github.com/benis-me/VibeOS) — packages/shared/src/domain/syscall.ts.
...
import type { VfsLocation } from './vfs';

/** Calls the AI may request, interpreted by the host SyscallInterpreter. */
export type Syscall =
  | {
      type: 'notify';
      title: string;
