/* Derived from VibeOS (https://github.com/benis-me/VibeOS) — apps/frontend/src/lib/sanitize.ts.
 * Adapted for DeepSeek Harness (dsh-vibeos): FORBID_TAGS gains 'style' (generated CSS must not
 * escape the window into the DSH page). Original license: MIT. */
