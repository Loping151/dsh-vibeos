/* Derived from VibeOS (https://github.com/benis-me/VibeOS) — apps/frontend/src/lib/patch.ts.
 * Adapted for DeepSeek Harness (dsh-vibeos). Must mirror the host's regionMerge semantics.
